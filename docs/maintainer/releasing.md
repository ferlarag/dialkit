...
Publish all crates at one version in this order: `dialkit-core`, `dialkit-api-generated`, then
`dialkit`. Each path dependency must also carry the release version.
