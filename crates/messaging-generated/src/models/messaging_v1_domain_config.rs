...
pub struct MessagingV1DomainConfig {
    ...
    #[serde(
        rename = "disable_https",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub disable_https: Option<Option<bool>>,
}

impl MessagingV1DomainConfig {
    pub fn new() -> MessagingV1DomainConfig {
