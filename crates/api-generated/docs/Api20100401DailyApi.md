...
------------- | ------------- | -------------
[**list_usage_record_daily**](Api20100401DailyApi.md#list_usage_record_daily) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records/Daily.json | 



## list_usage_record_daily

> models::ListUsageRecordDailyResponse list_usage_record_daily(account_sid, category, start_date, end_date, include_subaccounts, page_size, page, page_token)
...
[**models::ListUsageRecordDailyResponse**](ListUsageRecordDailyResponse.md)
