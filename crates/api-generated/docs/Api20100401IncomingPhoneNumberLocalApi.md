...
------------- | ------------- | -------------
[**create_incoming_phone_number_local**](Api20100401IncomingPhoneNumberLocalApi.md#create_incoming_phone_number_local) | **POST** /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json | 
[**list_incoming_phone_number_local**](Api20100401IncomingPhoneNumberLocalApi.md#list_incoming_phone_number_local) | **GET** /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json | 
...
**emergency_status** | Option<[**models::IncomingPhoneNumberLocalEnumEmergencyStatus**](IncomingPhoneNumberLocalEnumEmergencyStatus.md)> |  |  |
...
**voice_receive_mode** | Option<[**models::IncomingPhoneNumberLocalEnumVoiceReceiveMode**](IncomingPhoneNumberLocalEnumVoiceReceiveMode.md)> |  |  |
...
[**models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal**](api.v2010.account.incoming_phone_number.incoming_phone_number_local.md)
...
> models::ListIncomingPhoneNumberLocalResponse list_incoming_phone_number_local(account_sid, beta, friendly_name, phone_number, origin, page_size, page, page_token)
...
[**models::ListIncomingPhoneNumberLocalResponse**](ListIncomingPhoneNumberLocalResponse.md)
