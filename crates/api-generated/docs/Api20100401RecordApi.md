...
------------- | ------------- | -------------
[**list_usage_record**](Api20100401RecordApi.md#list_usage_record) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records.json | Retrieve a list of usage-records belonging to the account used to make the request



## list_usage_record

> models::ListUsageRecordResponse list_usage_record(account_sid, category, start_date, end_date, include_subaccounts, page_size, page, page_token)
...
[**models::ListUsageRecordResponse**](ListUsageRecordResponse.md)
