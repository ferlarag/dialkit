...
) -> Result<(), Error<DeleteConferenceRecordingError>> {
    let uri_str = format!(
...
pub async fn fetch_conference_recording(
    ...
    models::ApiV2010AccountConferenceConferenceRecording,
    Error<FetchConferenceRecordingError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Recordings/{Sid}.json",
        configuration.base_path,
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountConferenceConferenceRecording`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountConferenceConferenceRecording`"
                ))));
            }
        }
    } else {
...
pub async fn list_conference_recording(
...
) -> Result<models::ListConferenceRecordingResponse, Error<ListConferenceRecordingError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListConferenceRecordingResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListConferenceRecordingResponse`"
                ))));
            }
        }
    } else {
...
pub async fn update_conference_recording(
    ...
    models::ApiV2010AccountConferenceConferenceRecording,
    Error<UpdateConferenceRecordingError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Recordings/{Sid}.json",
        configuration.base_path,
