...
) -> Result<models::ApiV2010AccountSipSipCredentialListSipCredential, Error<CreateSipCredentialError>>
{
    let uri_str = format!(
        ...
        CredentialListSid = crate::apis::urlencode(params.credential_list_sid)
    );
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountSipSipCredentialListSipCredential`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountSipSipCredentialListSipCredential`"
                ))));
            }
        }
    } else {
...
) -> Result<(), Error<DeleteSipCredentialError>> {
    let uri_str = format!(
...
) -> Result<models::ApiV2010AccountSipSipCredentialListSipCredential, Error<FetchSipCredentialError>>
{
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{CredentialListSid}/Credentials/{Sid}.json",
        configuration.base_path,
...
pub async fn list_sip_credential(
...
) -> Result<models::ListSipCredentialResponse, Error<ListSipCredentialError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{CredentialListSid}/Credentials.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListSipCredentialResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListSipCredentialResponse`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountSipSipCredentialListSipCredential, Error<UpdateSipCredentialError>>
{
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{CredentialListSid}/Credentials/{Sid}.json",
        configuration.base_path,
