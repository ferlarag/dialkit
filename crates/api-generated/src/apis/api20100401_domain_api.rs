...
) -> Result<models::ApiV2010AccountSipSipDomain, Error<CreateSipDomainError>> {
    let uri_str = format!(
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomain`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomain`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountSipSipDomain, Error<FetchSipDomainError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
...
pub async fn list_sip_domain(
...
) -> Result<models::ListSipDomainResponse, Error<ListSipDomainError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListSipDomainResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListSipDomainResponse`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountSipSipDomain, Error<UpdateSipDomainError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
