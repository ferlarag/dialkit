...
pub async fn create_sip_auth_calls_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: CreateSipAuthCallsIpAccessControlListMappingParams,
) -> Result<
    models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping,
...
> {
    ...
    multipart_form_params.insert(
        ...
        params.ip_access_control_list_sid.to_string(),
    );
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateSipAuthCallsIpAccessControlListMappingError> =
...
pub async fn delete_sip_auth_calls_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: DeleteSipAuthCallsIpAccessControlListMappingParams,
) -> Result<(), Error<DeleteSipAuthCallsIpAccessControlListMappingError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSipAuthCallsIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_sip_auth_calls_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSipAuthCallsIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_sip_auth_calls_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: ListSipAuthCallsIpAccessControlListMappingParams,
) -> Result<
    models::ListSipAuthCallsIpAccessControlListMappingResponse,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListSipAuthCallsIpAccessControlListMappingResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListSipAuthCallsIpAccessControlListMappingResponse`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListSipAuthCallsIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
