...
pub struct CreateParticipantParams {
    ...
    pub emergency_caller_position: Option<String>,
    ...
    pub emergency_caller_location: Option<String>,
    ...
    pub emergency_zip_code: Option<String>,
    ...
    pub emergency_city: Option<String>,
    ...
    pub emergency_country: Option<String>,
}
...
pub async fn create_participant(
...
) -> Result<models::ApiV2010AccountConferenceParticipant, Error<CreateParticipantError>> {
    let uri_str = format!(
    ...
    if let Some(param_values) = params.status_callback_event {
        for param_value in param_values {
            multipart_form_params.insert("StatusCallbackEvent", param_value.to_string());
        }
    }
    ...
    if let Some(param_values) = params.conference_status_callback_event {
        for param_value in param_values {
            multipart_form_params.insert("ConferenceStatusCallbackEvent", param_value.to_string());
        }
    }
    ...
    if let Some(param_values) = params.recording_status_callback_event {
        for param_value in param_values {
            multipart_form_params.insert("RecordingStatusCallbackEvent", param_value.to_string());
        }
    }
    if let Some(param_values) = params.conference_recording_status_callback_event {
        for param_value in param_values {
            multipart_form_params.insert(
    ...
    if let Some(param_value) = params.passports {
        multipart_form_params.insert("Passports", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.emergency_caller_position {
        multipart_form_params.insert("EmergencyCallerPosition", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_caller_location {
        multipart_form_params.insert("EmergencyCallerLocation", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_name {
        multipart_form_params.insert("EmergencyName", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_address {
        multipart_form_params.insert("EmergencyAddress", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_zip_code {
        multipart_form_params.insert("EmergencyZipCode", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_city {
        multipart_form_params.insert("EmergencyCity", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_state {
        multipart_form_params.insert("EmergencyState", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_country {
        multipart_form_params.insert("EmergencyCountry", param_value.to_string());
    }
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountConferenceParticipant`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountConferenceParticipant`"
                ))));
            }
        }
    } else {
...
) -> Result<(), Error<DeleteParticipantError>> {
    let uri_str = format!(
...
) -> Result<models::ApiV2010AccountConferenceParticipant, Error<FetchParticipantError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Participants/{CallSid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
...
pub async fn list_participant(
...
) -> Result<models::ListParticipantResponse, Error<ListParticipantError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Participants.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListParticipantResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListParticipantResponse`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountConferenceParticipant, Error<UpdateParticipantError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Conferences/{ConferenceSid}/Participants/{CallSid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
