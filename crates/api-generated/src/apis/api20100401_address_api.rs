...
) -> Result<models::ApiV2010AccountAddress, Error<CreateAddressError>> {
    let uri_str = format!(
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountAddress`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountAddress`"
                ))));
            }
        }
    } else {
...
) -> Result<(), Error<DeleteAddressError>> {
    let uri_str = format!(
...
) -> Result<models::ApiV2010AccountAddress, Error<FetchAddressError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Addresses/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
...
pub async fn list_address(
...
) -> Result<models::ListAddressResponse, Error<ListAddressError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Addresses.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListAddressResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListAddressResponse`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountAddress, Error<UpdateAddressError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Addresses/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
