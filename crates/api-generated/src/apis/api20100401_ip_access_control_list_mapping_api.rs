...
pub async fn create_sip_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: CreateSipIpAccessControlListMappingParams,
) -> Result<
    models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping,
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateSipIpAccessControlListMappingError> =
...
pub async fn delete_sip_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: DeleteSipIpAccessControlListMappingParams,
) -> Result<(), Error<DeleteSipIpAccessControlListMappingError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSipIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_sip_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: FetchSipIpAccessControlListMappingParams,
) -> Result<
    models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping,
    Error<FetchSipIpAccessControlListMappingError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings/{Sid}.json",
        configuration.base_path,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSipIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_sip_ip_access_control_list_mapping(
    configuration: &configuration::Configuration,
    params: ListSipIpAccessControlListMappingParams,
) -> Result<
    models::ListSipIpAccessControlListMappingResponse,
    Error<ListSipIpAccessControlListMappingError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/IpAccessControlListMappings.json",
        configuration.base_path,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListSipIpAccessControlListMappingResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListSipIpAccessControlListMappingResponse`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListSipIpAccessControlListMappingError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
