...
) -> Result<(), Error<DeleteOutgoingCallerIdError>> {
    let uri_str = format!(
...
pub async fn fetch_outgoing_caller_id(
    configuration: &configuration::Configuration,
    params: FetchOutgoingCallerIdParams,
) -> Result<models::ApiV2010AccountOutgoingCallerId, Error<FetchOutgoingCallerIdError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/OutgoingCallerIds/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountOutgoingCallerId`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountOutgoingCallerId`"
                ))));
            }
        }
    } else {
...
pub async fn list_outgoing_caller_id(
    configuration: &configuration::Configuration,
    params: ListOutgoingCallerIdParams,
) -> Result<models::ListOutgoingCallerIdResponse, Error<ListOutgoingCallerIdError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListOutgoingCallerIdResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListOutgoingCallerIdResponse`"
                ))));
            }
        }
    } else {
...
pub async fn update_outgoing_caller_id(
    configuration: &configuration::Configuration,
    params: UpdateOutgoingCallerIdParams,
) -> Result<models::ApiV2010AccountOutgoingCallerId, Error<UpdateOutgoingCallerIdError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/OutgoingCallerIds/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
