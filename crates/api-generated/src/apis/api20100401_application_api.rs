...
) -> Result<models::ApiV2010AccountApplication, Error<CreateApplicationError>> {
    let uri_str = format!(
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountApplication`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountApplication`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountApplication, Error<FetchApplicationError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Applications/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
...
pub async fn list_application(
...
) -> Result<models::ListApplicationResponse, Error<ListApplicationError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Applications.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListApplicationResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListApplicationResponse`"
                ))));
            }
        }
    } else {
...
) -> Result<models::ApiV2010AccountApplication, Error<UpdateApplicationError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/Applications/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
