...
pub async fn create_sip_credential_list(
    configuration: &configuration::Configuration,
    params: CreateSipCredentialListParams,
) -> Result<models::ApiV2010AccountSipSipCredentialList, Error<CreateSipCredentialListError>> {
    let uri_str = format!(
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountSipSipCredentialList`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountSipSipCredentialList`"
                ))));
            }
        }
    } else {
...
pub async fn delete_sip_credential_list(
    configuration: &configuration::Configuration,
    params: DeleteSipCredentialListParams,
) -> Result<(), Error<DeleteSipCredentialListError>> {
    let uri_str = format!(
...
pub async fn fetch_sip_credential_list(
    configuration: &configuration::Configuration,
    params: FetchSipCredentialListParams,
) -> Result<models::ApiV2010AccountSipSipCredentialList, Error<FetchSipCredentialListError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
...
pub async fn list_sip_credential_list(
...
) -> Result<models::ListSipCredentialListResponse, Error<ListSipCredentialListError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ListSipCredentialListResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ListSipCredentialListResponse`"
                ))));
            }
        }
    } else {
...
pub async fn update_sip_credential_list(
    configuration: &configuration::Configuration,
    params: UpdateSipCredentialListParams,
) -> Result<models::ApiV2010AccountSipSipCredentialList, Error<UpdateSipCredentialListError>> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists/{Sid}.json",
        configuration.base_path,
        AccountSid = crate::apis::urlencode(params.account_sid),
