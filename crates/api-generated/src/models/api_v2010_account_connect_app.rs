...
impl DeauthorizeCallbackMethod {
...
impl Serialize for DeauthorizeCallbackMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DeauthorizeCallbackMethod {
...
impl std::fmt::Display for DeauthorizeCallbackMethod {
