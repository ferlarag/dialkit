...
pub struct ListAvailablePhoneNumberMachineToMachineResponse {
    ...
    #[serde(
        rename = "available_phone_numbers",
        skip_serializing_if = "Option::is_none"
    )]
    pub available_phone_numbers: Option<
        Vec<models::ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine>,
    >,
}
