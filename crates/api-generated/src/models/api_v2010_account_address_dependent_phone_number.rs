...
pub struct ApiV2010AccountAddressDependentPhoneNumber {
    ...
    pub address_requirements: Option<models::DependentPhoneNumberEnumAddressRequirement>,
    ...
    pub emergency_status: Option<models::DependentPhoneNumberEnumEmergencyStatus>,
