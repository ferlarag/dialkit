...
pub struct ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree {
    ...
    pub address_requirements: Option<models::IncomingPhoneNumberTollFreeEnumAddressRequirement>,
    ...
    pub capabilities: Option<Option<Box<models::ApiV2010AccountIncomingPhoneNumberCapabilities>>>,
    ...
    pub voice_receive_mode: Option<models::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode>,
    ...
    pub emergency_status: Option<models::IncomingPhoneNumberTollFreeEnumEmergencyStatus>,
    /// The SID of the emergency address configuration that we use for emergency calling from this phone number.
    #[serde(
        rename = "emergency_address_sid",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "emergency_address_status",
        skip_serializing_if = "Option::is_none"
    )]
    pub emergency_address_status:
        Option<models::IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus>,
...
impl Serialize for StatusCallbackMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for StatusCallbackMethod {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = String::deserialize(deserializer)?;
        Ok(match value.as_str() {
            "GET" => Self::Get,
...
impl std::fmt::Display for StatusCallbackMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl Serialize for VoiceFallbackMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VoiceFallbackMethod {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = String::deserialize(deserializer)?;
        Ok(match value.as_str() {
            "GET" => Self::Get,
...
impl std::fmt::Display for VoiceFallbackMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl Serialize for VoiceMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VoiceMethod {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = String::deserialize(deserializer)?;
        Ok(match value.as_str() {
            "GET" => Self::Get,
...
impl std::fmt::Display for VoiceMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
