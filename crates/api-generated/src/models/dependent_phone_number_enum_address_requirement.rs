...
impl DependentPhoneNumberEnumAddressRequirement {
...
impl Serialize for DependentPhoneNumberEnumAddressRequirement {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DependentPhoneNumberEnumAddressRequirement {
...
impl std::fmt::Display for DependentPhoneNumberEnumAddressRequirement {
